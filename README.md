# 🚀 Hack4Life — Hackathon 2026

![Hackathon](https://img.shields.io/badge/Hackathon-2026-blueviolet?style=for-the-badge&logo=rocket)
...
> 💡 *Descripción del Proyecto:* Solución web Full Stack orientada al sector salud para optimizar la gestión de recursos y realizar el monitoreo de métricas críticas en entornos de alta prevención y máxima seguridad.

---

## 📚 Documentación Técnica

El desarrollo de esta solución está respaldado por la siguiente estructura documental:

1. [*Ingeniería de Requerimientos*](./docs/ingenieria_requerimientos.md)
